---
title: "Dexamethasone - Disorder Of Eye"
sidebar: mydoc_sidebar
permalink: db01234-mesh-d005128-1.html
toc: false 
---


Path ID: `DB01234_MESH_D005128_1`
{% include image.html url="images/db01234-mesh-d005128-1.png" file="db01234-mesh-d005128-1.png" alt="db01234-mesh-d005128-1" %}
...
| <a href="https://identifiers.org/MESH:D005128">MESH:D005128 </a> | Disorder of eye | Disease |
|------------|------|---------|
...
| Inflammatory Response | POSITIVELY CORRELATED WITH | Disorder Of Eye |
|---------|-----------|---------|

Comment: MESH:D005128 is a generic term (https://en.wikipedia.org/wiki/Eye_disease) that can include sub-types where inflammation is an issue (then dexamethasone would be helpful). However it can include other types of diseases that have no inflammatory component.
